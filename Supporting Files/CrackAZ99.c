...
int main(int argc, char *argv[])
{
  for (int i = 0; i < 10; i++)
  {
    ...
    crack("$6$AS$XRTYYGrcMb5RzgzrzOKTPEgXxdaQ6qngsLOS.ieQmWC2sbZ6MvFwyOdlPT1ryf4zwYSBKqf8DDWlHMZaPY/ry0"); //Copy and Paste your ecrypted password here using EncryptShA512 program (BCD20)
